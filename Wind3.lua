  ...
  return[[
{
  ...
  function ac.new(aj,ak,al)
    ...
    ae.AddSignal(ap.UIListLayout:GetPropertyChangedSignal"AbsoluteContentSize",function()
      ai(ap,.06,{Size=UDim2.new(1, 0, 0, math.clamp(ap.UIListLayout.AbsoluteContentSize.Y+(am.Padding*2),0,am.MaxHeight))},Enum.EasingStyle.Quint,Enum.EasingDirection.InOut):Play()
    end)
    function am.Open(as)
      task.spawn(function()
  ...
  return function(aq)
    ...
    if ar.User then
      ...
      ay=aj("TextButton",{
        ...
        ai.NewRoundFrame(ar.UICorner-(ar.UIPadding/2),"Squircle",{
          ...
          aj("Frame",{
            ...
            aj("TextLabel",{
              Text=ar.User.Anonymous and"Anonymous"or game:GetService("Players").LocalPlayer.DisplayName,
              TextSize=17,
              ThemeTag={
                TextColor3="Text",
              },
            ...
            aj("TextLabel",{
              Text=ar.User.Anonymous and"anonymous"or game:GetService("Players").LocalPlayer.Name,
              TextSize=15,
              TextTransparency=.6,
              ThemeTag={
                TextColor3="Text",
      ...
      function ar.User.SetAnonymous(az,aA)
        ...
        ay.UserIcon.Frame.DisplayName.Text=aA and"Anonymous"or game:GetService("Players").LocalPlayer.DisplayName
  ...
  ai.AddSignal(ac.InputChanged,function(v)
    if v.UserInputType==Enum.UserInputType.MouseMovement or v.UserInputType==Enum.UserInputType.Touch then
      if isResizing and ar.CanResize then
        ...
        B=UDim2.new(B.X.Scale, math.clamp(B.X.Offset,ar.MinSize.X,ar.MaxSize.X), B.Y.Scale, math.clamp(B.Y.Offset,ar.MinSize.Y,ar.MaxSize.Y))
